...
\frame{%
    ...
    node[concept, color=green!50!black,text=white] {4dd6437}
    [clockwise from=0]
    child[concept color=green!50!black] {node[concept]{8ac0fed}}
    [clockwise from=0]
    child[concept color=green!50!black] {node[concept]{3092c78}}
    [clockwise from=0]
    child[concept color=green!50!black] {node[concept]{f55d65e}}
    [clockwise from=0]
    child[concept color=green!50!black] {node[concept]{a4c8b39}}
    [clockwise from=0]
    child[concept color=green!50!black] {node[concept]{2ac72a4}}
    [clockwise from=0]
    child[concept color=green!50!black] {node[concept]{48e6f6f}}
    [clockwise from=0]
    child[concept color=green!50!black] {node[concept]{42b3af2}}
    [clockwise from=0]
    child[concept color=green!50!black] {node[concept]{b7d0830}}
    [clockwise from=0]
    child[concept color=green!50!black] {node[concept]{c0cf800}}
    [clockwise from=0]
    child[concept color=green!50!black] {node[concept]{7df0c0a}}
    [clockwise from=0]
    child[concept color=green!50!black] {node[concept]{cfe76f4}};
    \end{tikzpicture}
\end{center}
}
